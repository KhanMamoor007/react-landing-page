...
export default function Comments() {
  ...
  return (
    <div className={cssClasses.commentsContainer}>
      <div
        className={`${cssClasses.commentsList} ${cssClasses.flexBetweenCenter} `}
      >
        {commentsData.map((comment) => {
          return (
            <div className={cssClasses.comments}>
              <div
                className={`${cssClasses.userDetails} ${cssClasses.flexBetweenCenter}`}
              >
      ...
      <div className={cssClasses.commentsControls}>
        <span
          className={`${cssClasses.commentsTracker} ${cssClasses.flexBetweenCenter}`}
        >
        ...
        <span className={cssClasses.btnContainer}>
          <Button
            className={`${classes.btn} ${classes.btnMargin}`}
            color="secondary"
            variant="outlined"
          >
            <ArrowBack />
          </Button>
          <Button className={classes.btn} color="secondary" variant="outlined">
            <ArrowForward />
          </Button>
        </span>
      </div>
